 ...
 * and set as callback in wp_list_comments()
 *
 * @since ???
...
function avia_inc_custom_comments( $comment, $args, $depth )
{
	...
	$aria_label = 'aria-label="' . __( 'Comment Info', 'avia_framework' ) . '"';
	 ...
	 * @return string
	 */
	$aria_label = apply_filters( 'avf_aria_label_for_header', $aria_label, __FILE__, $comment, $args, $depth );
    ...
    <li <?php comment_class(); ?> id="li-comment-<?php comment_ID() ?>">
        ...
        <article>
            ...
            <div class='comment_content'>
                <header class="comment-header" <?php echo $aria_label; ?> >
                    <?php
