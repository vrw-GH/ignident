...
if( ! class_exists( __NAMESPACE__ . '\aviaElementStylingBase', false ) )
{
	abstract class aviaElementStylingBase
	{
		...
		/**
		 * Stores styles for separate containers:
		 *
		...
		/**
		 * Stores classes for separate containers:
		 *
		...
		/**
		 * Stores data attributes for separate containers:
		 *
		 *		'container' => array( 'attr' => 'value', ... )
		 *
		 * @since 5.0
