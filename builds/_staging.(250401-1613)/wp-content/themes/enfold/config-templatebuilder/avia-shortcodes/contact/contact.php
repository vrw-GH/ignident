			...
			$c = array(
						...
						array(
							...
							'subtype'	=> array(
												...
												__( 'Other Element: Separator Headline', 'avia_framework' )	=> 'headline',
						...
						array(
							'name'		=> __( 'Date Only In Future', 'avia_framework' ),
							'desc'		=> __( 'Check if you want to limit selectable dates from current date to future dates only - first selection is used for all contact forms on the page.', 'avia_framework' ) ,
							'id'		=> 'date_limit',
							'type'		=> 'checkbox',
							'std'		=> '',
