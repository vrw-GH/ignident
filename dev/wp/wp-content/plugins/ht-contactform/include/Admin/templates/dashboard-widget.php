...
<?php
$info_data = \HTContactForm\Admin\Dashboard_Widget_Api::get_remote_data();
        ...
        <ul>
            <li>
                <a href="https://hasthemes.com/blog/" target="_blank">
                    <?php esc_html_e( 'Blog', 'ht-contactform' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
            <li>
                <a href="https://hasthemes.com/docs-category/ht-contact-forms/" target="_blank">
                    <?php esc_html_e( 'Documentation', 'ht-contactform' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
            <li>
                <a href="https://hasthemes.com/contact-us/" target="_blank">
                    <?php esc_html_e( 'Support', 'ht-contactform' ); ?>
                    <span aria-hidden="true" class="dashicons dashicons-external"></span>
                </a>
            </li>
        </ul>
