...
if( ! class_exists( 'avia_sc_table', false ) )
{
	class avia_sc_table extends aviaShortcodeTemplate
	{
			...
			$c = array(
						array(
							...
							'row_style'		=> array(
													...
													__( 'Dynamic Data Row', 'avia_framework' )	=> 'avia-dynamic-data-row'
												),
							'column_style'	=> array(
		...
		protected function get_element_styles_item( array $args )
		{
			 ...
			 * Ýou have to separate av_row and av_cell shortcodes here as both are called when creating the header.
			 *
