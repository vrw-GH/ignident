...
$advanced['top_bar'] = array(
	...
	'selector'		=> array(
		'#top #header_meta, #top #header_meta nav ul ul li[hover], #top #header_meta nav ul ul a, #top #header_meta nav ul ul' => array(
...
$advanced['main_menu_icon'] = array(
	...
	'selector'		=> array(
		...
		'.html_av-overlay-side #top #wrap_all div .av-burger-overlay-scroll #av-burger-menu-ul li:hover a, #top #wrap_all .av-burger-overlay .av-burger-overlay-scroll #av-burger-menu-ul li a:hover' => array(
...
$advanced['hover_overlay'] = array(
	...
	'selector'		=> array(
		...
		'#top [sections] .image-overlay .image-overlay-inside:before' => array(
								'icon_color'	=> 'background-color: %icon_color%;',
								'color'			=> 'color: %color%;'
							)
						),
	'sections'		=> true,
	'hover'			=> false,
	'edit'			=> array(
							'overlay_style' 	=> array( 'type' => 'select', 'name' => __( 'Overlay Style', 'avia_framework' ), 'options' => array(__( 'Default', 'avia_framework' ) => '', __( 'Minimal Overlay (No Icon)', 'avia_framework' ) => 'none', __( 'Icon only', 'avia_framework' ) => 'icon', __( 'Disable Overlay', 'avia_framework' ) => 'hide' ) ) ,
							'color' 			=> array( 'type' => 'colorpicker', 'name' => __( 'Icon Color', 'avia_framework' ) ),
...
$advanced['widget_title'] = array(
	...
	'selector'		=> array(
		'#top [sections] .widgettitle' => array(
								'style' => array( 'border', 'border-style:solid; border-width:1px; padding:10px; text-align:center; margin-bottom:15px' )
							),
		'html #top [sections] .widgettitle' => array(
								'style' => array( 'border-tp', 'border-style:solid; border-width:1px; padding:10px 0; border-left:none; border-right:none; margin-bottom:15px' )
							),
		'body#top #wrap_all [sections] .widgettitle' => array(
								'border_color'		=> 'border-color: %border_color%;',
								'background_color'	=> 'background-color: %background_color%;',
								'color'				=> 'color: %color%;',
