...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Locked options are hidden to keep element templates compact. Add a checkbox to the Customize tab that reveals their values while editing.', 'avia_framework' ),
...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Show your custom element buttons in one tab, or grouped into several tabs like the standard elements.', 'avia_framework' ),
...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Use one template for all subitems of an element, or let each subitem use its own. Changing this only affects elements you edit and save afterwards.', 'avia_framework' ),
...
$desc  = __( 'Select if you want to have access to the custom elements via the default WP CPT Screens. Links are added below theme options page link in dashboard and in admin bar &quot;New&quot;. Visibility depends on capability to manage custom elements.', 'avia_framework' );
$desc .= '<br />';
...
$desc .= '<br /><strong>';
$desc .=	__( 'After activating this feature you must reload backend to load the necessary menus to work with the CPT screens.', 'avia_framework' );
$desc .= '</strong>';
