...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Check if you want to delete expired merged and compressed CSS and JS files generated by the theme. Only recommended if you are NOT using a caching plugin (since a cached page might still use those files)', 'avia_framework' ),
