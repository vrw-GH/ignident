...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Show next/previous links on single posts (also used for portfolio). Developers can fine-tune it with the avf_post_nav_settings filter.', 'avia_framework' ),
			'id'		=> 'disable_post_nav',
			'type'		=> 'select',
			'no_first'	=> true,
			'std'		=> '',
...
$avia_elements[] =	array(
			...
			'desc'		=> __( 'Choose whether and how to show related posts. Related posts are matched by tags, so posts without tags show none.', 'avia_framework' ),
...
if( ! empty( $avia_config['social_share_array'] ) )
{
	$avia_elements[] =	array(
				...
				'desc'		=> __( 'Show share buttons at the bottom of your posts. Check the networks you want to include.', 'avia_framework' ) . $icon_info,
