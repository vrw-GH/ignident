...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Choose how the "added to cart" message behaves on single product pages built with the Layout Builder.', 'avia_framework' ),
...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Show a full-width banner with a description on the shop page. Pick the image size in the media library.', 'avia_framework' ),
			'id'		=> 'shop_banner',
			'type'		=> 'select',
			'std'		=> '',
			'no_first'	=> true,
...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Upload a large banner image for the shop description, shown as a background or responsive image. Pick the size in the media library.', 'avia_framework' ),
