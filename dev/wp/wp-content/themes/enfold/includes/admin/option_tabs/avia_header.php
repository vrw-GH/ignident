...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Choose whether and how to show the page title and breadcrumbs. You can override this on individual pages.', 'avia_framework' ),
			'id'		=> 'header_title_bar',
			'type'		=> 'select',
...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Label for the main header (logo and menus), read aloud by screen readers. Leave empty to skip it.', 'avia_framework' ),
...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Stop the small top bar (social icons, secondary menu, and extra info) from sticking to the top of the screen.', 'avia_framework' ),
...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Show a reading-progress bar below the header as visitors scroll. Requires the top header and sticky header.', 'avia_framework' ),
			'id'		=> 'reading_progress',
			'type'		=> 'select',
			'std'		=> '',
			'no_first'	=> true,
