...
$avia_elements[] = array(
			...
			'desc'			=> __( 'When a page uses a transparent header with content showing beneath it, set the logo and menu colors it should use here.', 'avia_framework' ),
...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Fade smoothly between pages as visitors navigate. Disable if it interferes with plugins that load content dynamically.', 'avia_framework' ),
...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Open images in the built-in lightbox when clicked. Uncheck if you use your own lightbox plugin.', 'avia_framework' ),
			'id'		=> 'lightbox_active',
			'type'		=> 'checkbox',
			'std'		=> 'true',
			'globalcss'	=> true,
...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Use one of your pages as a custom 404 error page. While selected, it is hidden from menus and search; deselect it to make it public again.', 'avia_framework' ),
			'attention'	=> $desc1,
			'id'		=> 'error404_custom',
			'type'		=> 'select',
			'no_first'	=> true,
...
$avia_elements[] = array(
			...
			'desc'		=> __( 'Turn on maintenance mode and send all visitors to a page of your choice. That page is hidden from menus and search; deselect it to make it public again.', 'avia_framework' ),
			'attention'	=> $desc1,
			'id'		=> 'maintenance_mode',
			'type'		=> 'select',
			'no_first'	=> true,
...
if( version_compare( $wp_version, '5.0', '>=' ) )
{
	...
	if( current_theme_supports( 'avia_gutenberg_post_type_support' ) )
	{
		$avia_elements[] = array(
					...
					'desc'				=> __( 'Use the classic editor for these post types and hide the Block editor (Gutenberg) links. Developers can override this per page with the avf_use_block_editor_for_post filter.', 'avia_framework' ),
