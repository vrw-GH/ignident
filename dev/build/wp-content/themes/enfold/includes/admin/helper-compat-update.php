...
add_action( 'ava_trigger_updates', 'avia_update_4_8_8', 22, 2 );

function avia_update_4_8_8( $prev_version, $new_version )
{
	//if the previous theme version is equal or bigger to 4.8.8 we don't need to update
...
add_action( 'ava_trigger_updates', 'avia_update_4_9', 23, 2 );

function avia_update_4_9( $prev_version, $new_version )
{
	//if the previous theme version is equal or bigger to 4.9 we don't need to update
...
add_action( 'ava_trigger_updates', 'avia_update_5_3', 24, 2 );

function avia_update_5_3( $prev_version, $new_version )
{
	global $avia_config;

	//if the previous theme version is equal or bigger to 5.3 we don't need to update
