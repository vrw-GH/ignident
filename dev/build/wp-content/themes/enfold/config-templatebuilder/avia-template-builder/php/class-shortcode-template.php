	...
	abstract class aviaShortcodeTemplate extends aviaBuilder\base\object_properties
	{
			...
			foreach( $elements as $element )
			{
				switch( $element['type'] )
				{
					...
					case "colorpicker":
						...
						break;
					case 'iconfont':
						$this->config['modal_on_load'][] = 'modal_load_iconfont_filter';
						break;
					case "datepicker":
		...
		*/
		...
		protected function sync_sc_defaults_array( array $defaults = array(), $is_modal_item = 'no_modal_item', $content = 'content' )
		{
			 ...
			 * @since 5.6.11
			 * @param array $result
			 * @param aviaShortcodeTemplate $this			shortcode class
			 * @param false|string $is_modal_item			'modal_item' | 'no_modal_item' | false
			 * @param false|string $content					'content' | 'no_content' | false
			 * @return array
			 */
			$result = apply_filters( 'avf_sync_sc_defaults_array', $result, $this, $is_modal_item, $content );
